           ...
           <script type="text/javascript" src="ElegyJSColorNotes.js" xml:space="preserve">  </script>
            ...
            <div id="sidebar">
                ...
                <div id="mainPage">
                   ...
                   <a id="sort"/> <h3>Sorted by Date of First Publication</h3>
                    
                    <h3>Remix: <a href="EccoLocSortType.html#sort">Click to Sort by Genre of Publication</a></h3>
                    
              
                
                <ul>
                    <xsl:apply-templates select="TEI//text//listBibl/bibl">
